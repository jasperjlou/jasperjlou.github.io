...
export const projectCollection: Collection = {
  ...
  fields: [
    ...
    { name: 'category', label: '项目分类', type: 'string', options: [{ value: 'holistic-assistant', label: 'Holistic Assistant' }, { value: 'ai-tools', label: 'AI + Tools · 多领域融合与工具实践' }], required: true },
    { name: 'repositoryVisibility', label: '源码可见性', type: 'string', options: ['public', 'private'], required: true },
    { name: 'visual', label: '项目展示形式', type: 'string', options: [{ value: 'campus', label: '校园与产品示意' }, { value: 'pipeline', label: '技术处理流程' }], required: true },
    { name: 'technicalTitle', label: '技术区标题', type: 'string', required: true },
    ...
    { name: 'liveUrl', label: '产品网址（无公开演示可留空）', type: 'string' },
    ...
    { name: 'heroImage', label: '项目主图（流程图项目可留空）', type: 'image' },
    { name: 'heroAlt', label: '主图说明', type: 'string' },
    { name: 'pipeline', label: '技术处理流程', type: 'object', list: true, fields: [
      { name: 'title', label: '步骤', type: 'string', required: true },
      { name: 'detail', label: '说明', type: 'string', required: true },
    ] },
    { name: 'engineering', label: '技术取舍', type: 'object', list: true, fields: [
      { name: 'title', label: '技术问题', type: 'string', required: true },
      { name: 'detail', label: '实现与原因', type: 'string', required: true, ui: { component: 'textarea' } },
    ] },
    { name: 'evidence', label: '代码与验证链接（只放公开链接）', type: 'object', list: true, fields: [
      { name: 'label', label: '名称', type: 'string', required: true },
      { name: 'url', label: '网址', type: 'string', required: true },
    ] },
    {
      name: 'metrics',
      label: '项目数字',
